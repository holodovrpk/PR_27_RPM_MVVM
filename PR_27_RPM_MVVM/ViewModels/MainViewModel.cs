    ...
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public Student SelectedStudent
        {
            ...
            set
            {
                ...
                OnPropertyChanged(); // ⚡️ Сообщаем Binding-системе, что значение свойства поменялось
            }
        }

        // ------------------------------------------------------------------------------
        // 4️⃣ КОНСТРУКТОР ViewModel
        // ------------------------------------------------------------------------------
        ...
        // ------------------------------------------------------------------------------
        // 7️⃣ INotifyPropertyChanged — уведомление интерфейса об изменениях
        // ------------------------------------------------------------------------------
